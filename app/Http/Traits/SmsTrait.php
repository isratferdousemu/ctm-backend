...
trait SmsTrait
{
    private $MerchantRegOtpTemplate = 'Thank you for registering on our platform. Your OTP for verification is {OTP}. It will expire in 10 minutes. Please enter this OTP on the registration page to complete the verification process. Thank you!';
    private $MerchantMailRegOtpTemplate = "Thank you for registering as a merchant on our platform. We have sent a one-time passcode (OTP) to your registered email address for verification purposes. <br/> <br/> Please enter the <h3> {OTP} </h3> on the registration page to complete the verification process. <br/> <br/> The OTP will expire in 10 minutes. If you didn't receive the OTP, please check your spam folder or request for a new one. Thanks for your cooperation!";


    private $MerchantMailAfterRegTemplate = " <div> <p>Dear {Merchant_Name},</p> <br/>
    ...
    private $MerchantSmsAfterRegTemplate = "Welcome to our platform! Your merchant account is being reviewed for approval. We appreciate your patience and will notify you as soon as your account is active. Thank you for signing up!";
}
