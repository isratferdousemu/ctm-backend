...
//            ],
            ...
            [
                ...
                'permissions' => [
                    ...
                    ["id" => 237, "name" => "activityLog-create", "page_url" => "/system-audit/activity-logs", "parent_page" => 1],
                    ["id" => 238, "name" => "activityLog-view", "page_url" => "/system-audit/activity-logs", "parent_page" => 1],
                    ["id" => 239, "name" => "activityLog-edit", "page_url" => "/system-audit/activity-logs/edit/:id", "parent_page" => 1],
                    ["id" => 240, "name" => "activityLog-delete", "page_url" => "/system-audit/activity-logs/delete", "parent_page" => 1],
