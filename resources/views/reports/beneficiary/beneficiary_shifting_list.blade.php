...
<table class="border-table">
    ...
    @foreach($beneficiaries as $index => $beneficiary)
        <tr>
            ...
            <td>{{app()->isLocale('bn') ? $beneficiary?->from_program_name_bn : $beneficiary?->from_program_name_en}}</td>
            <td>{{app()->isLocale('bn') ? $beneficiary?->to_program_name_bn : $beneficiary?->to_program_name_en}}</td>
